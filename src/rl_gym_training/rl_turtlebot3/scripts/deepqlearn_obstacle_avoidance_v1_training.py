...
if __name__ == '__main__':
    ...
    min_experiences = rospy.get_param("/turtlebot3_obstacle_avoidance_v1/min_experiences")
    max_experiences = rospy.get_param("/turtlebot3_obstacle_avoidance_v1/max_experiences")
    batch_size = rospy.get_param("/turtlebot3_obstacle_avoidance_v1/batch_size")
